...
class CallScreenCall extends StatefulWidget {
  final Call call;
  ...
  @override
  _CallScreenCallState createState() => _CallScreenCallState();
}

class _CallScreenCallState extends State<CallScreenCall> {
